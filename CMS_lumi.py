...
lumi_13TeV = {'2016':"35.9 fb^{-1}",'2017':"41.5 fb^{-1}",'2018':"59.7 fb^{-1}", 'Run2':"139 fb^{-1}"}
lumi_8TeV  = "19.7 fb^{-1}" 
lumi_7TeV  = "5.1 fb^{-1}"
lumi_sqrtS = ""
...
def CMS_lumi(pad,  iPeriod,  iPosX ):
    ...
    if( iPeriod==1 ):
        ...
        lumiText += lumi_13TeV['2016']
        lumiText += " (13 TeV)"
    elif ( iPeriod==5 ):
        lumiText += lumi_13TeV['2017']
        lumiText += " (13 TeV)"
    elif ( iPeriod==6 ):
        lumiText += lumi_13TeV['2018']
        lumiText += " (13 TeV)"
    elif ( iPeriod==7 ):
