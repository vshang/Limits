...
rateparam = {
    ...
    'rateWjetsAH1b'+year : 'WJetsToLNu',
    'rateWjetsAH2b'+year : 'WJetsToLNu',
...
#                    else: card += "%-25s" % "-"
    ...
    for p, m in rateparam.iteritems():
        if (('AH' in cat and 'AH' in p) or ('SL' in cat and 'SL' in p)):
            ...
            elif ("ZR" in cat and "Wjets" in p): continue
            elif ("WR" in cat and "Zjets" in p): continue
            elif (("AH0l0fSR" in cat and "2b" in p) or ("AH0l1fSR" in cat and "2b" in p)): continue
            elif ("2b" in cat and "1b" in p): continue
